...
//      fun(currentPage);
    ...
    "initPageEvent":function(listCount){
        $("#"+page.pageId +">div[class='pageItem']").on("click",function(){
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        var appendStr ="";
        appendStr+="<div class='"+prePageClass+"' page-data='1' page-rel='firstpage'>首页</div>";
        appendStr+="<div class='"+prePageClass+"' page-data='"+prePage+"' page-rel='prepage'>&lt;上一页</div>";
        ...
        for(var i=0;i<showPageNum;i++){
            ...
            appendStr+="<div class='"+itemPageClass+"' page-data='"+pageNumber+"' page-rel='itempage'>"+pageNumber+"</div>";
        }
        appendStr+="<div class='"+nextPageClass+"' page-data='"+nextPage+"' page-rel='nextpage'>下一页&gt;</div>";
        appendStr+="<div class='"+nextPageClass+"' page-data='"+pageCount+"' page-rel='lastpage'>尾页</div>";
       return appendStr;
